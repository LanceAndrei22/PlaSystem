 ...
 * @author mjbal
 */
public class restockGUI_netbeans extends javax.swing.JFrame {

    /**
     * Creates new form restockGUI_netbeans
     */
    public restockGUI_netbeans() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "Product ID", "Name", "Quantity", "Restock Value", "Incoming Qty"
            }
        ) {
        ...
        Design.setBackground(new java.awt.Color(0, 204, 51));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(Design, javax.swing.GroupLayout.DEFAULT_SIZE, 530, Short.MAX_VALUE))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(restockGUI_netbeans.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new restockGUI_netbeans().setVisible(true);
            }
        });
    }
